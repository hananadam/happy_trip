...
class SearchResultModify extends Component
{
    ...
    public function mount()
    {
        ...
        $this->destination = $this->destinationname.", ".$this->destinationcountry;
    }
    ...
    {
        return view('livewire.hotels.search-result-modify');
    }
