    ...
    <div class="container d-flex flex-row justify-content-between modify py-4">
        <div class="col-8 d-flex">
            <div class="d-flex flex-column">
                <h3> Happytrip <i class="fas fa-circle"></i> Payment </h3>
            </div>
        </div>
    </div>

    <div class="container-fluid mx-0 bg-light">
        <div class="container py-3">
            <p class="my-3 text-justify" style="min-height: 350px">
...
var tap = Tapjsli('pk_test_rchIsiojbMLzFkHa9CTgAxXp');
...
form.addEventListener('submit', function(event) {
  ...
  tap.createToken(card).then(function(result) {
    ...
    if (result.error) {
      ...
      $.get("{{asset('')}}pay?q="+ result.id, function(data){ 
        console.log(data);
				});
